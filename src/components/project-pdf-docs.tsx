        ...
        <View style={{ borderWidth: 6, borderColor: C.brand, padding: 24, height: "100%" }}>
          <View style={{ borderWidth: 1, borderColor: C.border, padding: 24, height: "100%" }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end", marginTop: 32 }}>
              ...
              <View style={{ alignItems: "center" }}>
                <Image src={seal} style={{ width: 80, height: 80, opacity: 0.9 }} />
              </View>
              <View style={s.sigBlock}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 12, fontSize: 8.5, color: C.muted }}>
            ...
            <Text style={{ fontSize: 8, color: C.muted, marginTop: 4, textAlign: "center" }}>Verify at: {COMPANY.website}</Text>
          </View>
        </View>
      </Page>
    </Document>
