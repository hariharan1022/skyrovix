...
export const STATE_DISTRICTS: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "Parvathipuram Manyam", "Sri Sathya Sai", "Tirupati", "Alluri Sitharama Raju"
  ],
  "Arunachal Pradesh": [
    ...
    "Lohit", "Namsai", "Changlang", "Tirap", "Longding", "Kamle", "Shi Yomi",
    "Leparada", "Pakke Kessang"
  ],
  "Assam": [
  ...
  "Haryana": [
    ...
    "Hisar", "Jhjjar", "Jind", "Kaithal", "Karnal", "Kurukshetra", "Mahendragarh",
  ...
  "Madhya Pradesh": [
    ...
    "Vidisha", "Niwari", "Mauganj", "Pandhurna", "Maihar"
  ],
  "Maharashtra": [
  ...
  "Manipur": [
    ...
    "Tamenglong", "Thoubal", "Ukhrul", "Kangpokpi", "Tengnoupal", "Pherzawl",
    "Noney", "Kamjong", "Jiribam", "Kakching"
  ],
  "Meghalaya": [
  ...
  "Nagaland": [
    ...
    "Peren", "Phek", "Tuensang", "Wokha", "Zunheboto", "Chümoukedima",
    "Niuland", "Tseminyu"
  ],
  "Odisha": [
  ...
  "Rajasthan": [
    ...
    "Anoopgarh", "Balotra", "Beawar", "Deeg", "Didwana-Kuchaman", "Dudu",
    "Gangapur City", "Kekri", "Khairthal-Tijara", "Kotputli-Behror", "Neem Ka Thana",
    "Phalodi", "Salumbar", "Sanchore", "Shahpura"
  ],
  "Sikkim": [
    "Gangtok", "Mangan", "Namchi", "Gyalshing", "Soreng", "Pakyong"
  ],
  "Tamil Nadu": [
  ...
  "Uttar Pradesh": [
    ...
    "Basti", "Bhadohi", "Bijnor", "Budaun", "Buldandshahr", "Chandauli", "Chitrakoot",
  ...
  "West Bengal": [
    ...
    "Hooghly", "Howrah", "Jalajguri", "Jhargram", "Kalimpong", "Kolkata", "Malda",
  ...
  "Jammu and Kashmir": [
    ...
    "Kathua", "Kishtwar", "Kulgam", "Kupwara", "Poonch", "Pulwama", "Ramban",
