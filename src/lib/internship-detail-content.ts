...
export const INTERNSHIP_DETAILS: Record<string, InternshipDetail> = {
  ...
  mernstack: detail({
    ...
    projects: [
      { title: "React Portfolio", description: "Responsive portfolio with routing and component architecture.", difficulty: "Beginner" },
      { title: "Blog Application", description: "Full-stack blog with posts, comments, and user profiles.", difficulty: "Intermediate" },
      { title: "E-Commerce Backend", description: "Products, cart, orders, and payment integration.", difficulty: "Advanced" },
      { title: "Real-Time Chat", description: "Socket.io chat with rooms and message history.", difficulty: "Advanced" },
    ],
  ...
  meanstack: detail({
    ...
    projects: [
      { title: "Angular Basics", description: "Components, modules, templates, and data binding.", difficulty: "Beginner" },
      { title: "Employee Portal", description: "Employee management with CRUD and department features.", difficulty: "Intermediate" },
      { title: "Inventory Management", description: "Real-time stock tracking and purchase orders.", difficulty: "Intermediate" },
      { title: "Dashboard", description: "Analytics dashboard with charts and data export.", difficulty: "Advanced" },
    ],
